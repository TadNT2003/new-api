...
func InitEnv() {
	...
	if os.Getenv("SESSION_SECRET") != "" {
		...
		if ss == "random_string" {
			...
			log.Println(LanguageString("Warning: SESSION_SECRET is set to the default value 'random_string', please change it to a random string.", "警告：SESSION_SECRET被设置为默认值'random_string'，请修改为随机字符串。"))
